...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    payphoneApiUrl: "https://pay.payphonetodoesposible.com/api/button",
    payphoneToken:
    ...
    payphoneResponseUrl:
      ...
      "https://api-hoor.magdata.com.ec/payphone/confirm",
    payphoneCancellationUrl:
      process.env.PAYPHONE_CANCELLATION_URL ||
      "https://api-hoor.magdata.com.ec/payphone/cancel",
  },
});
